...
On Error GoTo Err_Nalcomis
    ...
    Call GetScrollLock
        ...
        DoCmd.OpenQuery "Qry_ClearSelectedADHOCs"
        DoCmd.OpenQuery "Qry_SelectADHOCs"

        Set ADEN = CurrentDb
        Set rst = ADEN.OpenRecordset("Tbl_SelectedADHOCs", dbOpenTable)
...
On Error GoTo Err_OpenAdhoc
    ...
    SmartKeys 300, "%OR" ' Added a little extra delay for stability
...
On Error GoTo Err_SaveAsWindow
    ...
    SmartKeys 300, "%Y"      ' Send Alt+Y to confirm overwrite (if needed)
